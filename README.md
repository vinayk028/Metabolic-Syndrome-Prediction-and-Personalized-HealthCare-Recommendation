...
```
Metabolic-Syndrome-Prediction-and-Personalized-HealthCare-Recommendation/
├── MetS-App/
...
│   │   │   │   ├── Dashboard.tsx        # Results & analytics
│   │   │   │   ├── Profile.tsx
│   │   │   │   └── Resources.tsx
...
│   │   │   │   ├── requirements.txt
│   │   │   │   └── .venv/
│   │   │   ├── report-service/          # Spring Boot Report Service
│   │   │   │   ├── src/
│   │   │   │   │   ├── main/java/com/mets/reportservice/
...
│   │   │   │   │       └── application.yml
│   │   │   │   └── pom.xml
│   │   │   └── reportService.js         # Node wrapper
│   │   ├── routes/
│   │   │   ├── auth.js
│   │   │   ├── mets.js                  # Prediction routes
│   │   │   └── chat.js
│   │   ├── models/
...
│           └── Healthcare_Recommendations.json
│
├── MetS-Prediction-Model/               # ML Model Development
│   └── src/
│       ├── MetS_Final_Code.ipynb        # Model training
│       ├── MetS_Original_Dataset/
│       ├── MetS_Preprocessed_Dataset/
│       └── Optimal_Features_Set/
│
├── SYSTEM_ARCHITECTURE.md
├── CHAT_FLOW_DETAILED.md
├── Approach.md
├── requirements.txt
└── README.md (this file)
```
